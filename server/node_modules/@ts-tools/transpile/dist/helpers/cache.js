...
const filePathToCacheFileName = (filePath) => `${calcSha1((0, fs_1.getCanonicalPath)(filePath))}.json`;
exports.filePathToCacheFileName = filePathToCacheFileName;
function findCacheDirectory(workDirPath) {
    const packageJsonPaths = (0, fs_1.findAllUp)(workDirPath, 'package.json');
    const rootPackageJson = packageJsonPaths[packageJsonPaths.length - 1];
    return rootPackageJson ? (0, node_path_1.join)((0, node_path_1.dirname)(rootPackageJson), 'node_modules', '.cache') : undefined;
}
exports.findCacheDirectory = findCacheDirectory;
function compilerOptionsToCacheName(compilerOptions) {
    const moduleKind = typescript_1.default.ModuleKind[(0, typescript_2.getEmitModuleKind)(compilerOptions)];
    const scriptTarget = typescript_1.default.ScriptTarget[(0, typescript_2.getEmitScriptTarget)(compilerOptions)];
